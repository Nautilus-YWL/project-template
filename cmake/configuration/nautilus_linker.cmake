...
add_link_options(
  ${NAUTILUS_LINK_OPTIONS_COMMON}
  "$<IF:$<CONFIG:RELEASE>,${NAUTILUS_LINK_OPTIONS_RELEASE},${NAUTILUS_LINK_OPTIONS_DEVELOP}>"
  )

unset(NAUTILUS_LINK_OPTIONS_COMMON)
unset(NAUTILUS_LINK_OPTIONS_DEVELOP)
unset(NAUTILUS_LINK_OPTIONS_RELEASE)
