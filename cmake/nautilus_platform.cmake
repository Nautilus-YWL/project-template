...
if(CMAKE_VERSION VERSION_LESS 3.20)
  ...
  test_big_endian(NAUTILUS_ARCH_IS_BIG_ENDIANESS)
  set(NAUTILUS_ARCH_IS_BIG_ENDIANESS ${NAUTILUS_ARCH_IS_BIG_ENDIANESS} CACHE BOOL "Architecture is big endianess." FORCE)
else()
  foreach(lang C CXX CUDA)
    if(NOT ${CMAKE_${lang}_BYTE_ORDER} STREQUAL "")
      set(NAUTILUS_ARCH_ENDIANESS ${CMAKE_${lang}_BYTE_ORDER})
    endif()
  endforeach()
  if(NAUTILUS_ARCH_ENDIANESS STREQUAL "BIG_ENDIAN")
    set(NAUTILUS_ARCH_IS_BIG_ENDIANESS ON CACHE BOOL "Architecture is big endianess." FORCE)
  else()
    set(NAUTILUS_ARCH_IS_BIG_ENDIANESS OFF CACHE BOOL "Architecture is big endianess." FORCE)
  endif()
  unset(NAUTILUS_ARCH_ENDIANESS)
endif()
